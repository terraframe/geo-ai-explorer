...
(lpgvs:CensusTract)->[lpgvs:TractAtRisk]->(lpgvs:LeveedArea) (lpgvs:ChannelArea)->[lpgvs:FlowsThrough]->(lpgvs:CensusTract) (lpgvs:ChannelReach)->[lpgvs:ChannelHasLevee]->(lpgvs:LeveeArea) 
...
(lpgvs:LeveedArea)->[lpgvs:HasFloodRisk]->(lpgvs:Hospital) (lpgvs:LeveedArea)->[lpgvs:HasFloodRisk]->(lpgvs:RealProperty) (lpgvs:LeveedArea)->[lpgvs:HasFloodRisk]->(lpgvs:School)
(lpgvs:SchoolZone)->[lpgvs:HasSchoolZone]->(lpgvs:School)
(lpgvs:Watershed)->[lpgvs:WithinWatershed]->(lpgvs:RealProperty) (lpgvs:Watershed)->[lpgvs:WithinWatershed]->(lpgvs:School) (lpgvs:Watershed)->[lpgvs:WithinWatershed]->(lpgvs:Hospital)
(lpgvs:County)->[lpgvs:CENSUS_H]->(lpgvs:CensusTract)
(lpgvs:RecreationArea)->[lpgvs:ConnectedTo]->(lpgvs:RecreationArea)
(lpgvs:WaterBody)->[lpgvs:ConnectedTo]->(lpgvs:WaterBody)
(lpgvs:UsaceRecreationArea)->[lpgvs:ConnectedTo]->(lpgvs:Project)
(lpgvs:Project)->[lpgvs:ConnectedTo]->(lpgvs:ChannelReach)
(lpgvs:LandTransportation)->[lpgvs:ConnectedTo]->(lpgvs:RecreationArea)
(lpgvs:ChannelArea)->[lpgvs:ConnectedTo]->(lpgvs:ChannelReach)
(lpgvs:UsaceRecreationArea)->[lpgvs:ConnectedTo]->(lpgvs:ChannelReach)
(lpgvs:ChannelReach)->[lpgvs:ConnectedTo]->(lpgvs:Project)
(lpgvs:ChannelArea)->[lpgvs:ConnectedTo]->(lpgvs:Project)
(lpgvs:Project)->[lpgvs:ConnectedTo]->(lpgvs:Project)
(lpgvs:ChannelReach)->[lpgvs:ConnectedTo]->(lpgvs:ChannelReach)
(lpgvs:Waterway)->[lpgvs:ConnectedTo]->(lpgvs:Waterway)
(lpgvs:ChannelReach)->[lpgvs:ConnectedTo]->(lpgvs:UsaceRecreationArea)
(lpgvs:Project)->[lpgvs:ConnectedTo]->(lpgvs:UsaceRecreationArea)
(lpgvs:ChannelArea)->[lpgvs:ConnectedTo]->(lpgvs:UsaceRecreationArea)
(lpgvs:ChannelReach)->[lpgvs:ConnectedTo]->(lpgvs:ChannelArea)
(lpgvs:Project)->[lpgvs:ConnectedTo]->(lpgvs:ChannelArea)
(lpgvs:ChannelArea)->[lpgvs:ConnectedTo]->(lpgvs:ChannelArea)
(lpgvs:WaterBody)->[lpgvs:ConnectedTo]->(lpgvs:RecreationArea)
(lpgvs:LeveeArea)->[lpgvs:ConnectedTo]->(lpgvs:Project)
(lpgvs:ChannelArea)->[lpgvs:ConnectedTo]->(lpgvs:LeveeArea)
(lpgvs:ChannelReach)->[lpgvs:ConnectedTo]->(lpgvs:LeveeArea)
(lpgvs:RecreationArea)->[lpgvs:ConnectedTo]->(lpgvs:WaterBody)
(lpgvs:Waterway)->[lpgvs:ConnectedTo]->(lpgvs:WaterBody)
(lpgvs:RecreationArea)->[lpgvs:ConnectedTo]->(lpgvs:Waterway)
(lpgvs:WaterBody)->[lpgvs:ConnectedTo]->(lpgvs:Waterway)
(lpgvs:UsaceRecreationArea)->[lpgvs:ConnectedTo]->(lpgvs:LeveeArea)
(lpgvs:Project)->[lpgvs:ConnectedTo]->(lpgvs:LeveeArea)
(lpgvs:WaterTransportation)->[lpgvs:ConnectedTo]->(lpgvs:Waterway)
(lpgvs:WaterTransportation)->[lpgvs:ConnectedTo]->(lpgvs:WaterTransportation)
(lpgvs:Waterway)->[lpgvs:ConnectedTo]->(lpgvs:WaterTransportation)
(lpgvs:Waterway)->[lpgvs:ConnectedTo]->(lpgvs:RecreationArea)
(lpgvs:UsaceRecreationArea)->[lpgvs:ConnectedTo]->(lpgvs:ChannelArea)
(lpgvs:LeveeArea)->[lpgvs:ConnectedTo]->(lpgvs:UsaceRecreationArea)
(lpgvs:LeveeArea)->[lpgvs:ConnectedTo]->(lpgvs:ChannelArea)
(lpgvs:LeveeArea)->[lpgvs:ConnectedTo]->(lpgvs:ChannelReach)
(lpgvs:RecreationArea)->[lpgvs:ConnectedTo]->(lpgvs:WaterTransportation)
(lpgvs:UsaceRecreationArea)->[lpgvs:ConnectedTo]->(lpgvs:UsaceRecreationArea)
(lpgvs:WaterTransportation)->[lpgvs:ConnectedTo]->(lpgvs:RecreationArea)
